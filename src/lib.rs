// src/lib.rs
/*
 * Core library for NodeFramework
 */
...
#[derive(Debug)]
pub struct NodeFrameworkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NodeFrameworkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NodeFramework processing");
    
    let mut processor = NodeFrameworkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NodeFrameworkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NodeFrameworkProcessor::new(false);
